...
{
    public function __construct(private Connection $connection, private EventStatusMachine $statuses, private EventAccess $access, private LicenseService $licenses, private AuditLogger $audit) {}

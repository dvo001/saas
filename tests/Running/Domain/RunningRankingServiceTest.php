...
final class RunningRankingServiceTest extends TestCase
{
 ...
 public function testTimeRejectsInvalidMinutesAndExcessPrecision():void{$this->expectException(\DomainException::class);TimeValue::parse('x:23.4',TimePrecision::Tenths);}
 public function testTimeDoesNotSilentlyTruncatePrecision():void{$this->expectException(\DomainException::class);TimeValue::parse('83.45',TimePrecision::Tenths);}
 ...
 public function testMissingTieBreakTimeRanksBehindAnExistingTime():void{$ranked=(new RunningRankingService())->qualification([['id'=>1,'times'=>[120]],['id'=>2,'times'=>[120,140]]]);self::assertSame([2,1],array_column($ranked,'id'));}
